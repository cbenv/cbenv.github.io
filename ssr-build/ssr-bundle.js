...
// removed by extract-text-webpack-plugin
module.exports = {"portfolio":"portfolio__2ny0K","viewResumeButton":"viewResumeButton__2ju3r","viewResumeLink":"viewResumeLink__306VG"};
...
// removed by extract-text-webpack-plugin
module.exports = {"card":"card__2a8Ev"};
...
var anchor_Anchor = function (_Component) {
  ...
  Anchor.prototype.render = function render(props) {
    return Object(preact_min["h"])(
      "a",
      { href: props.href, target: "_blank", rel: "noopener noreferrer", className: props.className },
      props.children
    );
  };
...
// EXTERNAL MODULE: ./components/layout/style.css
var layout_style = __webpack_require__("o1x9");
...
var button_Button = function (_Component) {
  ...
  function Button() {
    ...
    return button__possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  Button.prototype.render = function render(props) {
    return Object(preact_min["h"])(
      'button',
      { className: button_style_default.a.button + ' ' + props.className + ' mdl-button mdl-js-button mdl-button--raised mdl-button--colored' },
      props.children
    );
  };
...
var home_Home = function (_Component) {
  ...
  Home.prototype.componentDidMount = function componentDidMount() {
    ...
    var text2 = 'I am Chris and I love building web applications!';
    var refreshRate = 60;

    var tick = function tick() {
      if (!_this2.actionButtons) return;
      _this2.actionButtons.style.opacity = 0;
      if (index1 < text1.length) {
        _this2.greeting1.innerHTML += text1.charAt(index1);
        index1 += 1;
        setTimeout(tick, refreshRate);
      } else if (index2 < text2.length) {
        _this2.greeting2.innerHTML += text2.charAt(index2);
        index2 += 1;
        setTimeout(tick, refreshRate);
      } else {
        _this2.actionButtons.style.opacity = 1;
      }
    };
    tick();
  };
  ...
  Home.prototype.render = function render() {
    ...
    return Object(preact_min["h"])(
      ...
      Object(preact_min["h"])('h2', { ref: function ref(element) {
          _this3.greeting = element;
        } }),
      Object(preact_min["h"])(
        'h2',
        null,
        Object(preact_min["h"])('div', { ref: function ref(element) {
            _this3.greeting1 = element;
          } }),
        Object(preact_min["h"])('div', { ref: function ref(element) {
            _this3.greeting2 = element;
          } })
      ),
      Object(preact_min["h"])(
        'div',
        { className: home_style_default.a.homeActions, ref: function ref(element) {
            _this3.actionButtons = element;
          } },
        _ref,
        _ref2
      )
...
var card_Card = function (_Component) {
  ...
  Card.prototype.render = function render(props) {
    return Object(preact_min["h"])(
      'div',
      { className: card_style_default.a.card + ' ' + props.className + ' mdl-card mdl-shadow--2dp' },
      Object(preact_min["h"])(
        'div',
...
// EXTERNAL MODULE: ./components/chip/style.css
var chip_style = __webpack_require__("hVI0");
var chip_style_default = /*#__PURE__*/__webpack_require__.n(chip_style);
...
var chip_Chip = function (_Component) {
  chip__inherits(Chip, _Component);

  function Chip() {
    chip__classCallCheck(this, Chip);

    return chip__possibleConstructorReturn(this, _Component.apply(this, arguments));
  }

  Chip.prototype.render = function render(props) {
    return Object(preact_min["h"])(
      'span',
      { className: chip_style_default.a.chip + ' ' + props.className + ' mdl-chip' },
      Object(preact_min["h"])(
        'span',
...
// CONCATENATED MODULE: ./routes/portfolio/cases.js
var cases = [{
  url: 'https://github.com/cbenv/github-dashboard',
  title: 'GitHub Dashboard',
  description: 'Simple dashboard to keep track of pull requests from configurable list of GitHub repositories.',
  completion: '2017',
  techs: ['NodeJS', 'ExpressJS', 'Angular', 'Material Design', 'Server-Side Rendering', 'RxJS']
}, {
  url: 'https://github.com/cbenv/mailer',
  title: 'Mailer',
  description: 'Lightweight node server to send email via external SMTP server. This application is a thin wrapper around Nodemailer.',
  completion: '2017',
  techs: ['NodeJS', 'ExpressJS', 'SMTP']
}, {
  url: 'https://github.com/cbenv/mean-passport-quickstart',
  title: 'Portal',
  ...
  completion: 'Ongoing',
  techs: ['NodeJS', 'ExpressJS', 'REST API', 'Angular', 'JWT', 'Crpytography', 'SMTP']
}, {
  url: '',
  title: 'HTCNA',
  description: 'Website for the Holy Trinity Community North America where guests may find information on this lay community while members have access to restricted internal web application, where they may read the statutes, access documents, look at materials, post questions, get announcements, request intercession, etc. Numerous user groups are available, each with its own priviledges and restrictions. The web application also provides RESTful backend for B2B companion mobile application to be used exclusively by its members.',
  completion: 'Ongoing',
  techs: ['PHP', 'Slim', 'MySQL', 'REST API', 'Mobile Hybrid Application', 'AngularJS']
}, {
  url: 'https://PF1010.systemsbiology.net/',
  title: 'Feed 1010',
  description: 'Started by the Institute Systems of Biology Seattle, the project consists of constructing the backend of the webpage using Flask; the frontend of the webpage using HTML5, CSS3, AngularJS, and jQuery; as well hybrid iOS and Android application built on Apache Cordova and Ionic Frameworks. Project Feed 1010 is meant to promote aquaponics and the web service aims to provide farmers, teachers, and students a gateway to their and others\'s aquaponics systems. Visitors may explore the existing systems, read the curriculum, or simply look at other resources. Users may see the latest readings, submit readings, and analyze and compare systems with interactive graphs. Making friend requests, posting to timeline, browsing through newsfeed, subscribing to a system, are some of the features of the social component.',
  completion: '2016',
  techs: ['Flask', 'AngularJS', 'jQuery', 'REST API', 'MySQL', 'Mobile Hybrid Application'],
  responsibilities: ['Illustrated mock-ups and redesigned aquaponics.systemsbiology.net.', 'Set up common theme for the website and developed the backend based on Flask framework.', 'Integrated Google’s Google+ API for user authentication and utilized Maps API to display map.', 'Established common contracts with other teams, totaling around 25 developers, and exchanged APIs for integration.']
}, {
  url: 'https://github.com/cbenv/property-rental',
  title: 'Property Rental',
  description: 'The application is written in Java and deployed on Heroku which provides the backend for an application similar to airbnb. This Dropwizard application documents its API with the help of Swagger. The application communicates with PostgreSQL via Hibernate ORM where queries against the database is written in HQL. For continous integration the test-driven-development makes use of Codeship.',
  completion: '2016',
  techs: ['Dropwizard', 'REST API', 'Swagger', 'Hibernate', 'PostgreSQL', 'Continuous Integration'],
  responsibilities: ['Led a team of 4 to develop the backed for an application similar to Airbnb.', 'Held weekly meeting/scrum to keep the team up-to-date, to resolve uncertainty, and to distribute tasks followed by discussing responsibilities and assigning them to team members.', 'Tuned Swagger for easier maintenance of documentation and Codeship for agile, continuous, and test-driven-development.']
}, {
  url: '',
  title: 'Gringotts',
  description: 'A complete rewrite of LOQ, a past project. Gringotts is a password manager with support for two-steps authentication as well as password generator. The hybrid mobile application is able to scan QR code to parse token information or to enter it manually. All data are encrypted and stored in the cloud for backup and for ease of access across devices. Two steps authentication can be either time-based (TOTP) or counter-based (HOTP). The hashing algorithms to generate token can be SHA1, SHA256, or SHA512. The number of digits of token can range from 6 to 8.',
  completion: '2016',
  techs: ['NodeJS', 'ExpressJS', 'MongoDB', 'Mobile Hybrid Application', 'AngularJS', 'REST API', 'Cryptography', 'QR Code'],
  responsibilities: ['Architected and tested the whole application stack from backend to frontend.', 'Researched various encryption algorithms, the degree of protection, as well as ease of integration.', 'Incorporated Stanford JavaScript Crypto Library (SJCL) for encryption and Cordova Barcode Scanner to interpret QR Code containing parameters to generate two-step-authentication token.']
}, {
  url: '',
  title: 'Vertical Search Engine',
  description: 'Search engine powered by elasticsearch where documents are more than 30000 raw web pages crawled using Python. The crawl respects each website\'s robot.txt and maintains one second delay between requests to avoid overloading and possible IP ban while smartly filters out irrelevant websites by inspecting their metadata using Regular Expression. As the Python script reads through each website document statistics are computed. Algorithms supported for document ranking include elasticsearch\'s ranking, TF-IDF, Okapi-TF, Okapi-BM25, Laplace Unigram LM, Jelinek-Mercer Unigram LM, as well as Google\'s Page Ranking. Calaca serves as the frontend to search against the elasticsearch.',
  completion: '2015',
  techs: ['Elasticsearch', 'Vector Space Retrieval', 'Language Model', 'Page Ranking', 'Regular Expression', 'Calaca'],
  responsibilities: ['Wrote Python script to crawl over 30000 webpages overnight while still respecting website\'s robot.txt and maintaining at least a second delay between requests made to the same host.', 'Implemented TF-IDF, Okapi-TF, Okapi-BM25, Laplace Unigram LM, Jelinek-Mercer Unigram LM, as well as Google\'s Page Ranking algorithm to calculate document ranking.', 'Designed web interface based on Calaca to search for relevant articles stored in elasticsearch.']
}, {
  url: 'https://github.com/cbenv/orate-mobile',
  title: 'Orate',
  description: 'Companion mobile application for Catholics. It provides easy access to the daily readings complete with lectionary number and liturgy color, daily reflections, and liturgy of the hour. In addition there are collections of prayers such as the rosaries, station of the cross, as well as a list of saints and examination of conscience. The content of the application is fetched from external websites and Regular Expression is used to extract relevant information and beautify presentation.',
  completion: '2015',
  techs: ['Mobile Hybrid Application', 'AngularJS', 'REST API', 'Regular Expression']
}, {
  url: 'https://github.com/cbenv/restaurant-pos',
  title: 'Restaurant POS System',
  description: 'Point of Sale system meant to be used by restaurants to manage online orders and delivery. There exist three user roles namely manager, driver, and customer. Customer is able to place order, view its status, as well as track the driver\'s position while on delivery. Driver exposes their location to customers and managers, notifies the system of their availability, and confirms delivery completion. Manager on the other hand is capable of processing orders, assigning orders to drivers, and updating the restaurant menu. Feedback system is available for the customers, the drivers involved, as well as the managers to communicate.',
  completion: '2015',
  techs: ['NodeJS', 'AngularJS', 'ExpressJS', 'MongoDB', 'REST API']
}, {
  url: '',
  title: 'Dota Guide',
  description: 'Collaborative guide for Dota 2 gamers. This Java EE application is written in JSP and allows users to submit skill build along with item build for heroes in Dota 2. Users may also view guides, comment on them, and mark them as favorites. Heroes are grouped by their primary attributes and basic information on heroes\' skills as well as items are fetched by parsing Valve Data File.',
  completion: '2014',
  techs: ['JSP', 'Tomcat', 'MySQL', 'JDBC', 'REST API', 'jQuery']
}, {
  url: '',
  title: 'LOQ',
  description: 'Password manager with support for two-steps authentication as well as password generator. The native iOS application is able to scan QR code to parse token information or to enter it manually. All data are stored locally to avoid exposing user\'s information to the outside. Data may be retrieved for backup purposes through iTunes. Two steps authentication can be either time-based (TOTP) or counter-based (HOTP). The hashing algorithms to generate token can be SHA1, SHA256, or SHA512. The number of digits of token can range from 6 to 8. The application can communicate with a complimentary OSX Application to send clipboard that contains the credentials of a website.',
  completion: '2014',
  techs: ['CoreData', 'Zeroconf Bonjour']
}];

/* harmony default export */ var portfolio_cases = (cases);
...
var portfolio__ref = Object(preact_min["h"])(
  'h3',
  null,
  'Portfolio'
);
...
var portfolio_Portfolio = function (_Component) {
  ...
  function Portfolio() {
    ...
    var _this = portfolio__possibleConstructorReturn(this, _Component.call(this));

    _this.renderCase = _this.renderCase.bind(_this);
    return _this;
  }

  Portfolio.prototype.renderCase = function renderCase(item) {
    var title = item.url ? Object(preact_min["h"])(
      anchor_Anchor,
      { href: item.url },
      item.title
    ) : Object(preact_min["h"])(
    ...
    var chips = Object(preact_min["h"])(
      'div',
      null,
      item.techs.map(function (tech, index) {
        return Object(preact_min["h"])(
          chip_Chip,
          { key: index },
          tech
    ...
    var supportingText = item.description;
    return Object(preact_min["h"])(card_Card, { title: title, chips: chips, supportingText: supportingText });
  };
  ...
  Portfolio.prototype.render = function render() {
    ...
    return Object(preact_min["h"])(
      'div',
      { className: portfolio_style_default.a.portfolio },
      portfolio__ref,
      Object(preact_min["h"])(
        'div',
        null,
        portfolio_cases.map(function (item) {
          return _this2.renderCase(item);
        })
      ),
      Object(preact_min["h"])(
        'div',
        ...
        Object(preact_min["h"])(
          anchor_Anchor,
          { className: portfolio_style_default.a.viewResumeLink, href: '/assets/documents/resume.pdf' },
          Object(preact_min["h"])(
            button_Button,
            { className: portfolio_style_default.a.viewResumeButton },
            'View Resume'
          )
        )
      )
...
var layout__ref = Object(preact_min["h"])(
  ...
  Object(preact_min["h"])(
    ...
    'Christoforus Benvenuto'
  ),
  Object(preact_min["h"])('div', { className: 'mdl-layout-spacer' }),
  Object(preact_min["h"])(
    'nav',
    { className: 'mdl-navigation mdl-layout--large-screen-only' },
    Object(preact_min["h"])(
      match["Link"],
      { className: 'mdl-navigation__link', activeClassName: 'active', href: '/' },
      'Home'
    ),
    Object(preact_min["h"])(
      match["Link"],
      { className: 'mdl-navigation__link', activeClassName: 'active', href: '/portfolio' },
      'Portfolio'
    )
  )
);

var layout__ref2 = Object(preact_min["h"])(
  'span',
  { className: 'mdl-layout-title' },
  'Menu'
);
...
var _ref4 = Object(preact_min["h"])(portfolio_Portfolio, { path: '/portfolio' });

var _ref5 = Object(preact_min["h"])(
  'div',
  { className: 'mdl-mega-footer__top-section' },
  Object(preact_min["h"])(
    'div',
    { className: 'mdl-mega-footer__left-section' },
    Object(preact_min["h"])(
      anchor_Anchor,
      { href: 'https://www.linkedin.com/in/cbenv' },
      'LinkedIn'
    ),
    Object(preact_min["h"])(
      anchor_Anchor,
      { href: 'https://github.com/cbenv' },
      'GitHub'
    ),
    Object(preact_min["h"])(
      'a',
      { href: 'mailto:christoforus@benvenuto.me' },
      'Email'
    )
  ),
  Object(preact_min["h"])(
    'div',
    { className: 'mdl-mega-footer__right-section' },
    '2018 \xA9 Christoforus Benvenuto'
  )
);
...
var layout_Layout = function (_Component) {
  ...
  function Layout() {
    ...
    var _this = layout__possibleConstructorReturn(this, _Component.call(this));
  ...
  Layout.prototype.handleRoute = function handleRoute(event) {
    this.currentUrl = event.url;
  };

  Layout.prototype.toggleDrawer = function toggleDrawer() {
  ...
  Layout.prototype.render = function render() {
    ...
    return Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        'header',
        { className: layout_style_default.a.header + ' mdl-layout__header' },
        layout__ref
      ),
      Object(preact_min["h"])(
        'div',
        { className: layout_style_default.a.drawer + ' mdl-layout__drawer' },
        layout__ref2,
        Object(preact_min["h"])(
          'nav',
          ...
          Object(preact_min["h"])(
            match["Link"],
            { className: 'mdl-navigation__link', activeClassName: 'active', onClick: this.toggleDrawer, href: '/' },
            'Home'
          ),
          Object(preact_min["h"])(
            match["Link"],
            { className: 'mdl-navigation__link', activeClassName: 'active', onClick: this.toggleDrawer, href: '/portfolio' },
            'Portfolio'
          )
        )
      ),
      Object(preact_min["h"])(
        ...
        { ref: function ref(element) {
          ...
          }, className: layout_style_default.a.content + ' mdl-layout__content' },
        Object(preact_min["h"])(
      ...
      Object(preact_min["h"])(
        'footer',
        { className: layout_style_default.a.footer + ' mdl-mega-footer' },
        _ref5
      )
    );
  };
...
var app__ref = Object(preact_min["h"])(
  ...
  Object(preact_min["h"])(
    Helmet["Helmet"],
    null,
    Object(preact_min["h"])('link', { rel: 'stylesheet', href: 'https://fonts.googleapis.com/icon?family=Material+Icons' }),
    Object(preact_min["h"])('link', { rel: 'stylesheet', href: 'https://code.getmdl.io/1.3.0/material.teal-indigo.min.css' }),
    Object(preact_min["h"])('script', { src: 'https://code.getmdl.io/1.3.0/material.min.js' })
  ),
  Object(preact_min["h"])(layout_Layout, null)
);
...
// removed by extract-text-webpack-plugin
module.exports = {"home":"home__MseGd","homeActions":"homeActions__1xoIR"};
...
// removed by extract-text-webpack-plugin
module.exports = {"chip":"chip__2MYTV"};
...
// removed by extract-text-webpack-plugin
module.exports = {"header":"header__2isiY","drawer":"drawer__2vmbW","footer":"footer__32rMb","content":"content__1Eh31"};
